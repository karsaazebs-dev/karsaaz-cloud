...
export const MOCK_FILES: FileItem[] = [
  {
    ...
    modifiedAt: daysAgo(1), modifiedLabel: 'Yesterday', type: 'video',
  ...
  },
  {
    ...
    modifiedAt: daysAgo(2), modifiedLabel: '2 days ago', type: 'document',
  ...
  },
  {
    ...
    modifiedAt: daysAgo(2), modifiedLabel: '2 days ago', type: 'image',
    pinned: true, path: '/BalanceSheet.Png', owner: 'Alex Johnson'
  },
  {
    id: '4', name: 'Documents', size: 0, sizeLabel: '4.2 GB',
    modifiedAt: daysAgo(5), modifiedLabel: '12 Nov', type: 'folder',
  ...
  },
  {
    ...
    modifiedAt: daysAgo(0), modifiedLabel: '2h ago', type: 'document',
  ...
  '/Documents': [
    {
      ...
      path: '/Documents/Invoice_2024.pdf', parentPath: '/Documents', owner: 'Alex Johnson'
    },
    {
      id: 'd2', name: 'Contracts', size: 0, sizeLabel: '120 MB',
      modifiedAt: daysAgo(3), modifiedLabel: formatDate(daysAgo(3)), type: 'folder',
      isFolder: true, path: '/Documents/Contracts', parentPath: '/Documents', owner: 'Alex Johnson'
    }
  ],
  '/UI Design': [
    {
      ...
      path: '/UI Design/Dashboard.fig', parentPath: '/UI Design', owner: 'Alex Johnson'
    }
  ]
}
