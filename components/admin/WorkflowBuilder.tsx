...
export function WorkflowBuilder({
  ...
  const { data: registry, isLoading } = useWorkflowRegistry();
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center gap-2 py-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Enable an app that provides workflow operations (e.g. automated tagging or
              file access control) to create flow rules.
            </p>
          </div>
        ) : (
