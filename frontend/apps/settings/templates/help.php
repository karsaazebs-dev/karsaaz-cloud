...
<?php if ($_['knowledgebaseEmbedded'] === true) : ?>
	<div id="app-navigation" role="navigation" tabindex="0">
		...
		<?php } ?>
			...
			<li>
				<a href="https://karsaaz.com/support" class="help-list__link icon-category-office" target="_blank" rel="noreferrer noopener">
					<span class="help-list__text">
			...
			<li>
				<a href="https://karsaaz.com/support" class="help-list__link icon-comment" target="_blank" rel="noreferrer noopener">
					<span class="help-list__text">
						<?php p($l->t('Support')); ?> ↗
					</span>
				</a>
		...
		<div class="help-wrapper">
			<div class="help-content">
				<h2 class="help-content__heading">
					<?php p($l->t('Karsaaz Cloud help & privacy resources')); ?>
				</h2>
				...
				<a href="https://karsaaz.com/support" class="button" target="_blank" rel="noreferrer noopener">
