...
abstract class Fetcher {
	...
	// Karsaaz: app store is disabled (airgap). Empty default prevents any outbound call.
	public const APP_STORE_URL = '';
	...
	protected function getEndpoint(): string {
		// Karsaaz: app store disabled. Use APP_STORE_URL constant (empty) as the fallback.
		return $this->config->getSystemValueString('appstoreurl', self::APP_STORE_URL) . '/' . $this->endpointName;
	}
}
