...
class LookupPlugin implements ISearchPlugin {
	...
	public function search($search, $limit, $offset, ISearchResult $searchResult): bool {
		...
		// Karsaaz: lookup_server is cleared in airgap config. Empty fallback prevents any outbound call.
		$lookupServerUrl = $this->config->getSystemValueString('lookup_server', '');
