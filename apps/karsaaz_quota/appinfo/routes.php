...
return [
    'ocs' => [
        ...
        ['name' => 'Quota#getMe',         'url' => '/api/v1/me',                   'verb' => 'GET'],
        ['name' => 'Quota#provision',     'url' => '/api/v1/provision',          'verb' => 'POST'],
        ['name' => 'Quota#updateProfile',  'url' => '/api/v1/users/{uid}/profile','verb' => 'PUT'],
