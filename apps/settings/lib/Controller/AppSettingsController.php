...
class AppSettingsController extends Controller {
	...
	public function viewApps(): TemplateResponse {
		...
		// Karsaaz: app store is disabled; usercontent.apps.nextcloud.com removed from allowed image domains.
	...
	/**
	 * Karsaaz: app store is disabled. Proxy preview URL function returns empty to avoid
	 * any outbound calls to usercontent.apps.nextcloud.com.
	 */
